...
- any model has to be **complete** 
- models should be as **small as possible** 

Minimal cover Fc  for a set F of fds:
- Fc is equivalent to F
- all fds have the form X → A (where A is a single attribute, canonical form)
...
<img src="./img/boyle.png" width="670" height="auto">
<img src="./img/boyle2.png" width="670" height="auto">
...
<img src="./img/third.png" width="670" height="auto">
...
<img src="./img/third2.png" width="670" height="auto">
